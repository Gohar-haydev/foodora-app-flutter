...
class UpdateProfileUseCase {
  ...
  Future<Result<UserEntity>> call({required String name, required String phone, File? image}) async {
    return await repository.updateProfile(name: name, phone: phone, image: image);
  }
}
